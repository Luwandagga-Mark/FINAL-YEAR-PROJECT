"""
Django settings for myfinalyear project.
...
SECRET_KEY = 'django-insecure-e%dg*pta)$&rfa+q^gyiyq5mt6$m$uwmuhfab3i768!!_@-031'
...
CSRF_TRUSTED_ORIGINS = ['https://final-year-project-n9rt.onrender.com']
# Password validation
